        ...
        <Accordion className="text-left">
          ...
          <Accordion.Content active={activeIndex === 0}>
            <p>
              ...
              στην ηλικία που δε θα έχετε τη δυνατότητα να αγωνίζεστε για αυτό!
              Όταν σταματήσετε να εργάζεστε, ενώ θα έχετε ακόμα μπροστά σας
              πολλά χρόνια ζωής, τα έσοδά σας πιθανά να περιορίζονται μόνο στη
              σύνταξη, που θα’ναι μικρότερη από το εισόδημα που είχατε όταν
              εργαζόσασταν. Φροντίστε, λοιπόν, το μέλλον σας προσδιορίζοντας από
              σήμερα - σύμφωνα με τις δυνατότητές σας - την ηλικία και το ποσό
              που επιθυμείτε, για να απολαμβάνετε στο μέλλον όσα δικαιούστε! Με
              τα προγράμματα της Εθνικής Ασφαλιστικής μπορείτε να εξασφαλίσετε
              ένα υψηλό βιοτικό επίπεδο και μετά τη συνταξιοδότησή σας, με
              ευελιξία και προσιτό ασφάλιστρο.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 8}>
            <p>
              ...
              ασφαλιστούμε σε μεγάλη ηλικία, ίσως αυτό να μην μπορεί να γίνει ή
              να γίνει με όρους που δεν μας ικανοποιούν απόλυτα.
            </p>
          </Accordion.Content>
          <Accordion.Title
          ...
          <Accordion.Content active={activeIndex === 4}>
            <p>
              ...
              και διαθέτετε κάποιο εφάπαξ ποσό που θέλετε να το αξιοποιήσετε, η
              Εθνική Ασφαλιστική διαθέτει Πρόγραμμα με το οποίο μπορείτε να
          ...
          <Accordion.Content active={activeIndex === 5}>
            <p>
              Μπορείτε να πληρώνετε τα ασφάλιστρα σύμφωνα με τον οικονομικό σας
              προγραμματισμό. Ανάλογα με την επιλογή σας, μπορείτε να
              καταβάλλετε τα ασφάλιστρα ετησίως, εξαμηνιαίως, τριμηνιαίως ή
              μηνιαίως, ενώ αν επιλέξετε το Νέο Συνταξιοδοτικό Πρόγραμμα ΕΘΝΙΚΗ
              ΣΥΝΤΑΞΗ έχετε επιπλέον τη δυνατότητα να ενισχύετε τη μελλοντική
              εγγυημένη παροχή σας μέσω έκτακτων καταβολών.
            </p>
          </Accordion.Content>
          <Accordion.Title
          ...
          <Accordion.Content active={activeIndex === 6}>
            <p>
              Η Εθνική Ασφαλιστική, κατανοώντας απόλυτα τις οικονομικές συνθήκες
              και τις απαιτήσεις του σήμερα αλλά και τις ανησυχίες για το αύριο,
              σχεδιάζει και προσφέρει λύσεις σε κάθε άνθρωπο που ενδιαφέρεται
              πραγματικά για την κάλυψη των συνταξιοδοτικών του αναγκών. Μερικά
              μόνο από τα οφέλη που σας προσφέρει ένα Συνταξιοδοτικό Πρόγραμμα
              της Εθνικής Ασφαλιστικής είναι τα εξής:
              <ol>
                <li>
                ...
                <li>
                  προσαρμογή του προγράμματος στις οικονομικές σας δυνατότητες,
                </li>
